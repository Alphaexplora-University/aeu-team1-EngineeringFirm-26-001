...
export default function AboutPage() {
  return (
    <main>
      <section className="mx-auto mt-64 mb-72">
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-8 md:grid-cols-12">
          <div className="md:col-span-5">
            <motion.h2
              ...
              viewport={{ once: true }}
              className="font-headline mb-8 text-4xl font-bold tracking-wide"
            >
            ...
            >
              Founded on the principles of architectural integrity and
              structural innovation, AlphaExplora has spent decades redefining
              what is possible in modern engineering. We don't just build; we
              orchestrate complexity into seamless performance.
            </motion.p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              ...
              >
                <div className="overflow-hidden grayscale transition-all duration-700 group-hover:grayscale-0">
                  <img
